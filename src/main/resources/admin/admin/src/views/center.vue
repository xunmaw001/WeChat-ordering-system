  ...
  <div>
    ...
    >  
     <el-row>
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='shangjia'"  label="商家号" prop="shangjiahao">
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='shangjia'"  label="电话" prop="dianhua">
...
export default {
  ...
  methods: {
    onUpdateHandler() {
      ...
      if( 'shangjia' ==this.flag && this.ruleForm.dianhua&&(!isMobile(this.ruleForm.dianhua))){
