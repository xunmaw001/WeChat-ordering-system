      ...
      <div class="login-form">
		...
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm">
			...
			<!-- <div v-if="tableName=='shangjia'" class="input-group">
			   <div class="label">商家号</div>
			   <div class="input-container">
			     <input v-model="ruleForm.shangjiahao" class="input" type="text" placeholder="商家号">
			   </div>
			 </div> -->
			<el-form-item label="商家号" class="input" v-if="tableName=='shangjia'">
			  <el-input v-model="ruleForm.shangjiahao" autocomplete="off" placeholder="商家号"  />
			</el-form-item>
			<!-- <div v-if="tableName=='shangjia'" class="input-group">
			   <div class="label">密码</div>
			   <div class="input-container">
			...
			<el-form-item label="电话" class="input" v-if="tableName=='shangjia'">
