<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="商家号" prop="shangjiahao">
          <el-input v-model="ruleForm.shangjiahao" 
              placeholder="商家号" clearable  :readonly="ro.shangjiahao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="商家号" prop="shangjiahao">
              <el-input v-model="ruleForm.shangjiahao" 
  ...
  methods: {
    ...
    init(id,type) {
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          var json = data.data;
		if(json.shangjiahao!=''&&json.shangjiahao){
	...
	this.ruleForm.meishixiangqing = this.ruleForm.meishixiangqing.replace(reg,'../../../springboottl6mm/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
