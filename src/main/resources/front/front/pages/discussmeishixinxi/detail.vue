		...
		<view class="container">
            <view class="detail-content">
				...
				<view class="detail-list-item" :style='{"padding":"0","boxShadow":"0 0 0px rgba(0,0,0,.3)","margin":"0","borderColor":"rgba(37, 37, 37, 1)","backgroundColor":"#fff","borderRadius":"0","borderWidth":"0 0 2rpx","width":"100%","borderStyle":"dashed ","height":"auto"}'>
					...
					<view  class="text" :style='{"padding":"0 10rpx","boxShadow":"0 0 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,0)","color":"#333","textAlign":"left","borderRadius":"0","borderWidth":"0","width":"calc(100% - 200rpx)","lineHeight":"auto","fontSize":"28rpx","borderStyle":"solid"}'>{{detail.refid}}</view>
				</view>
				<view class="detail-list-item" :style='{"padding":"0","boxShadow":"0 0 0px rgba(0,0,0,.3)","margin":"0","borderColor":"rgba(37, 37, 37, 1)","backgroundColor":"#fff","borderRadius":"0","borderWidth":"0 0 2rpx","width":"100%","borderStyle":"dashed ","height":"auto"}'>
					...
					<view  class="text" :style='{"padding":"0 10rpx","boxShadow":"0 0 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,0)","color":"#333","textAlign":"left","borderRadius":"0","borderWidth":"0","width":"calc(100% - 200rpx)","lineHeight":"auto","fontSize":"28rpx","borderStyle":"solid"}'>{{detail.nickname}}</view>
				</view>
...
<script>
	export default {
		...
		async onShow(options) {
			...
			let cleanType = uni.getStorageSync('discussdiscussmeishixinxiCleanType')
			if(cleanType){
				uni.removeStorageSync('discussdiscussmeishixinxiCleanType')
				this.mescroll.num = 1
		...
		methods: {
			// 支付
			onPayTap(){
				uni.setStorageSync('paytable','discussmeishixinxi');
			...
			onAcrossTap(tableName,crossOptAudit,statusColumnName,tips,statusColumnValue){
				uni.setStorageSync('crossTable','discussmeishixinxi');
			...
			// 获取详情
			async init(){
				let res = await this.$api.info('discussmeishixinxi', this.id);
			...
			async upCallback(mescroll) {
                let res = await this.$api.list('discussdiscussmeishixinxi', {
					page: mescroll.num,
					limit: 10,
					refid: this.id
				});
			...
			// 添加评论
			async onCommentTap() {
				this.$utils.jump(`../discussdiscussmeishixinxi/add-or-update?refid=${this.id}`)
			},
			onSHTap() {
			...
			async onFinishTap() {
				...
				await this.$api.update('discussmeishixinxi', this.detail);
				this.$utils.msg('审核成功');
